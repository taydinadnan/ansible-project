...
resource "null_resource" "config" {
  ...
  connection {
    ...
    type = "ssh"
    user = "ec2-user"
    private_key = file("/Users/adnan/Desktop/207-Ansible-publish-website-postgresql-nodejs-react/adnan.pem")
  ...
  provisioner "file" {
    # Do not forget to define your key file path correctly!
    source = "/Users/adnan/Desktop/207-Ansible-publish-website-postgresql-nodejs-react/adnan.pem"
